  ...
  CourseListScreen({super.key}) {
    controller.searchController.addListener(() {
      if (controller.searchController.text.isNotEmpty) {
        ...
        controller.filteredList.value = controller.courseList;
      }
    });
  }
          ...
          Column(
            children: [
              ...
              Obx(() {
                ...
                } else if (controller.courseList.isEmpty) {
                  return Expanded(
                    child: Center(
                      child: Text(
                        'course_list_empty'.tr,
                        style: TextStyle(
                          color: AppColors.primaryText,
                          fontSize: 26,
                          fontWeight: FontWeight.w600,
                  ...
                  return Padding(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return courseCardBuilder(
                          controller.filteredList[index].name ?? '',
                          controller.filteredList[index].code ?? '',
