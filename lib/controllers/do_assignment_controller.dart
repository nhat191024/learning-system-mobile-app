...
class DoAssignmentController extends GetxController {
  Rx<AssignmentModel> assignment =
      AssignmentModel(
        id: 0,
        type: '',
        title: '',
  ...
  final ClassDetailController classDetailController = Get.find<ClassDetailController>();
  ...
  void onInit() async {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      print('Assignment ID: ${assignmentId.value}');
      print('Class ID: ${classId.value}');
  ...
  submitAssignment({bool isTimeUp = false}) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        classDetailController.fetchStudentAssignmentPoint(classId.value);
        Get.back();
